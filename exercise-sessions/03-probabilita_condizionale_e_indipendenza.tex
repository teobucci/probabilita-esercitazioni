...
\item $A\Bot B\iff A\Bot B\complementary \iff A\complementary \Bot B\iff A\complementary \Bot B\complementary$.
\end{enumerate}
\begin{definition}
...
A_{k} \Bot \text{allora} \ A_{k}\complementary \Bot ,
\end{gather*}
...
\PP( A_{1} \cap B_{1}) & =\PP\left( A_{1} \cap \bigcap _{k=2}^{42} A_{k}\complementary\right)\overset{\Bot }{=}\PP( A_{1})\prod _{k=2}^{42}\PP\left( A_{k}\complementary\right)\\
...
\PP( A_{1} \cap A_{2} \mid B_{2}) & =\frac{\PP( A_{1} \cap A_{2} \cap B_{2})}{\PP( B_{2})} =\frac{\PP\left( A_{1} \cap A_{2} \cap \bigcap _{k=3}^{42} A_{k}\complementary\right)}{\PP( B_{2})}\\
 & \overset{\Bot }{=}\frac{\PP( A_{1})\PP( A_{2})\PP\left(\bigcap _{k=3}^{42} A_{k}\complementary\right)}{\PP( B_{2})}\\
