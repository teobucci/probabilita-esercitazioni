...
\left( A_{42} |\bigcap _{k=1}^{41} A_{k}\comp\right)
\end{equation*}
...
\left( A_{42} |\bigcap _{k=1}^{41} A_{k}\comp\right) =\underbrace{\mathbb{P}( A_{42}) =\mathbb{P}( A)}_{\text{primo punto}} \approx 0.0556
\end{equation*}
...
\begin{aligned}
\mathbb{P}( A_{1} \cap A_{2} |B_{2}) & =\frac{\mathbb{P}( A_{1} \cap A_{2} \cap B_{2})}{\mathbb{P}( B_{2})} =\frac{\mathbb{P}\left( A_{1} \cap A_{2} \cap \bigcap _{k=3}^{42} A_{k}\comp\right)}{\mathbb{P}( B_{2})}\\
...
\item $\mathbb{P}\left( A_{42} |\bigcup _{k=1}^{41} A_{k}\comp\right) =\mathbb{P}( A_{42}) =\mathbb{P}( A) =p$
...
\mathbb{P}( V_{\text{cons}}) =\mathbb{P}( V_{\text{cons}} |A)\mathbb{P}( A) +\mathbb{P}\left( V_{\text{cons}} |A\comp\right)\mathbb{P}\left( A\comp\right) =\frac{1}{3}
\end{equation*}
\begin{enumerate}
...
\item $\mathbb{P}\left( V_{\text{cons}} |A\comp\right) =0$, se so che non ho scelto il pacco contenente l'assegno e lo conservo, allora sono sicuro di perdere.
...
allora\begin{equation*}
\mathbb{P}( V_{\text{camb}}) =\underbrace{\mathbb{P}( V_{\text{camb}} |A)}_{0}\underbrace{\mathbb{P}( A)}_{\frac{1}{3}} +\underbrace{\mathbb{P}\left( V_{\text{camb}} |A\comp\right)}_{1}\underbrace{\mathbb{P}\left( A\comp\right)}_{\frac{2}{3}} =\frac{2}{3}
\end{equation*}
\end{enumerate}
...
\mathbb{P}( B_{2}) =\underbrace{\mathbb{P}( B_{2} |B_{1})}_{\frac{1}{2}}\underbrace{\mathbb{P}( B_{1})}_{\frac{1}{2}} +\mathbb{P}\left( B_{2} |B_{1}\comp\right)\underbrace{\mathbb{P}\left( B_{1}\comp\right)}_{\frac{1}{2}}
\end{equation*}

Ora, $\mathbb{P}\left( B_{2} |B_{1}\comp\right) =\frac{1}{3}$, infatti se alla prima estrazione è uscita $R$, alla seconda estrazione nell'urna ci sono $2B$ e $1R$. Allora $\mathbb{P}( B_{2}) =\frac{1}{4} +\frac{1}{6} =\frac{5}{12}$.
...
\mathbb{P}( B_{1} \cup B_{2}) & =1-\mathbb{P}\left( B_{1}\comp \cap B_{2}\comp\right)\\
 & =1-\mathbb{P}\left( B_{2}\comp |B_{1}\comp\right)\mathbb{P}\left( B_{1}\comp\right) =1-\frac{1}{3} =\frac{2}{3}
\end{aligned}
\end{equation*}
...
\item $\begin{aligned}
\mathbb{P}\left(\bigcap\limits _{k=1}^{n} B_{k}\comp\right) & =\mathbb{P}\left( B_{1}\comp\right)\mathbb{P}\left( B_{2}\comp |B_{1}\comp\right) \cdots \mathbb{P}\left( B_{n}\comp |B_{1}\comp \cap \cdots \cap B_{n-1}\comp\right)\\
