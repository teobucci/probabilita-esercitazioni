...
\end{equation*}
	...
	\begin{gather*}
		...
		A_{k} \indep \text{allora} \ A_{k}\comp \indep ,
	\end{gather*}
	quindi
	\begin{align*}
	...
	\begin{align*}
		\PP(A_{1} \cap B_{1}) & =\PP\left(A_{1} \cap \bigcap_{k=2}^{42} A_{k}\comp\right)\overset{\indep }{=}\PP(A_{1})\prod_{k=2}^{42}\PP\left(A_{k}\comp\right)\\
	...
	\begin{align*}
		\PP(A_{1} \cap A_{2} \mid B_{2}) & =\frac{\PP(A_{1} \cap A_{2} \cap B_{2})}{\PP(B_{2})} =\frac{\PP\left(A_{1} \cap A_{2} \cap \bigcap_{k=3}^{42} A_{k}\comp\right)}{\PP(B_{2})}\\
		 & \overset{\indep }{=}\frac{\PP(A_{1})\PP(A_{2})\PP\left(\bigcap_{k=3}^{42} A_{k}\comp\right)}{\PP(B_{2})}\\
