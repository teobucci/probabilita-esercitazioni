...
\begin{enumerate}
	...
	\item L'evento \event{almeno un $15$ su $42$ estrazioni} si traduce formalmente in
	\begin{equation*}
		\bigcup_{k=1}^{42} A_{k}
	\end{equation*}
...
\begin{enumerate}
	\item $\PP(B\mid A) =\frac{1}{5000} =0.0002$
	...
	\begin{equation*}
		\PP(B\mid A,D) \geq \frac{1}{1+\frac{\PP(D)}{\PP(B\mid A)}} =\frac{1}{1+\frac{5}{100}} =\frac{20}{21} =0.9524
	\end{equation*}
