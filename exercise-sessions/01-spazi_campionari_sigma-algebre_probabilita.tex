...
\begin{enumerate}
	\item $\bigcup\limits _{k=1}^{\infty } E_{k}\comp$\\
	$\mathcal{A}$: $E_{k} \in \mathcal{A} \forall k\implies  E_{k}\comp \in \mathcal{A} \forall k\implies  \bigcap\limits _{k=1}^{\infty } E_{k}\comp \in \mathcal{A}$
