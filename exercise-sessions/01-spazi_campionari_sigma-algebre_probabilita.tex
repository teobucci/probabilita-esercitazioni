...
Per $k=1,2,\NN$, si consideri $\Omega =\{0,1\}^{k}$ lo spazio degli esiti di $1$, $2$ o infinite prove di Bernoulli. In tutti e tre i casi, si consideri l'evento $E=$ \event{successo alla prima prova}, e si descriva esplicitamente la $\sigma$-algebra $\mathcal{A} =\sigma (E)$.
