...
\item $\P( A\cup B) =1.1$,
\item $\P( A\cap B) =0.28$,
\item $\P\left( B\cap A^{c}\right) \geq 0.3$,
\item $\P\left( A\cap B^{c}\right) \leq 0.3$.
\end{enumerate}
\Esercizio{}
...
\end{oss}
\item $\left(\liminf\limits _{n} E_{n}\right)^{c} =\underbrace{\left(\bigcup\limits _{n=1}^{\infty }\bigcap\limits _{m\geq n} E_{m}\right)^{c} =\bigcap\limits _{n=1}^{\infty }\bigcup\limits _{m\geq n} E_{m}^{c}}_{\text{Leggi di De Morgan}} =:\limsup\limits _{n} E_{n}^{c}$
...
\begin{enumerate}
\item $\P( B) =\overbrace{\P\left(\left( B\cap A^{c}\right) \cup ( A\cap B)\right) =\underbrace{\P\left( B\cap A^{c}\right)}_{\geq 0} +\P( A\cap B)}^{\text{perché gli insiemi sono disgiunti}} \geq \P( A\cap B)$
...
\begin{equation*}
\P\left( B\cap A^{c}\right) =\underbrace{\P( B)}_{=0.7} -\underbrace{\P( A\cap B)}_{\leq 0.4} \geq 0.7-0.4=0.3
\end{equation*}
\item V, infatti\begin{equation*}
\begin{cases}
\P\left( A\cap B^{c}\right) \leq \P( A) =0.4\\
\P\left( A\cap B^{c}\right) \leq \P\left( B^{c}\right) =1-\P( B) =1-0.7=0.3
\end{cases}\mathbb{\implies  P}\left( A\cap B^{c}\right) \leq 0.3
\end{equation*}
\end{enumerate}
\Soluzione
\begin{enumerate}
