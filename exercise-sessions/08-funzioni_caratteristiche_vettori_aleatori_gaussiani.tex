...
\end{aligned}
\end{gather*}
\begin{thm}[La funzione caratteristica di una probabilità caratterizza la probabilità]$\\$
...
\]
\end{rem}
\begin{thm}[Fattorizzazione della funzione caratteristica per famiglie di VA]
...
\end{thm}
\begin{coro}[Legge della somma di variabili indipendenti]$\\$
