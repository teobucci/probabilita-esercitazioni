...
\item $X\sim\PPP(\lambda)\implies\varphi_X(u)=e^{ \lambda (e^{i u}-1)}$
\item $Z\sim\NNN(0,1)\implies\varphi_X(u)=e^{-u^2/2}$
\item $X\sim\NNN(\mu,\sigma^2)\implies\varphi_X(u)=e^{iu\mu-\sigma^2u^2/2}$
\end{itemize}
...
\[
X\sim\delta_t,\ t\in\RR\iff\varphi_X(u)=e^{iut} \qquad X\sim\PPP(\lambda),\ \lambda>0\iff\varphi_X(u)=e^{ \lambda (e^{i u}-1)}
\]
\[
Z\sim\NNN(0,1)\iff\varphi_X(u)=e^{-u^2/2} \qquad X\sim\NNN(\mu,\sigma^2),\ \mu\in\RR,\ \sigma^2>0\iff\varphi_X(u)=e^{iu\mu-\sigma^2u^2/2}
\]
...
\[
X\sim \GGG(p),\ p\in(0,1)\iff \varphi_X(u)=\frac{pe^{iu}}{1-e^{iu}(1-p)}
\]

\Esercizio{} %4
Sia $X$ una variabile aleatoria reale.
\begin{enumerate}
\item [(a)] Si mostri che $X\sim \UUU([-a,a])\iff\varphi_X(u)=\dfrac{\sin(au)}{au}$.
\item [(b)] Si mostri che $X\sim  \UUU([a,b])\iff\varphi_X(u)=e^{iu\frac{a+b}{2}}\ \dfrac{\sin\left(\frac{b-a}{2}u\right)}{\frac{b-a}{2}u}$.
\item [(c)] Si mostri che $X\sim\EEE(\lambda)\iff\varphi_X(u)=\dfrac{\lambda}{\lambda-iu}$.
\item [(d)] Si mostri che $X$ tale che $-X\sim\EEE(\lambda)\iff\varphi_X(u)=\dfrac{\lambda}{\lambda+iu}$.
\end{enumerate}
...
\item [(b)] Si mostri che $X_1,\dots,X_n\iid\EEE(\lambda)\implies X_1+\cdots+X_n\sim\Gamma(n,\lambda)$.
\item [(c)] Si mostri che $Z\sim\NNN(0,1)\implies Z^2\sim\Gamma\left(\frac{1}{2},\frac{1}{2}\right)=\chi^2(1)$.
\item [(d)] Si mostri che $Q=Z_1^2+\cdots+Z_n^2$, con $Z_1,\dots,Z_n\iid\NNN(0,1)\implies Q\sim\Gamma\left(\frac{n}{2},\frac{1}{2}\right)=\chi^2(n)$.
\end{enumerate}
...
Quindi
\[
X\sim \UUU([-a,a]),\ a\in[0,+\infty)\iff\varphi_X(u)=\frac{\sin(au)}{au}=\text{sinc}(au)
\]
\begin{oss}
...
\[
Y:=X-\frac{a+b}{2}\sim\UUU\left(\left[-\frac{b-a}{2},\frac{b-a}{2}\right]\right)\implies X=\frac{a+b}{2}+Y
\]
Allora
\begin{gather*}
\begin{aligned}
...
Quindi
\[
X\sim  \UUU([a,b]),\ a,b\in\RR\iff\varphi_X(u)=e^{iu\frac{a+b}{2}}\ \frac{\sin\left(\frac{b-a}{2}u\right)}{\frac{b-a}{2}u}=e^{iu\frac{a+b}{2}}\ \text{sinc}\left( \frac{b-a}{2}u \right)
\]
...
Quindi
\[
X\sim\EEE(\lambda),\ \lambda>0\iff\varphi_X(u)=\frac{\lambda}{\lambda-iu}
\]
Per quanto riguarda media e varianza
\[
...
Si ha
\[
X\text{ tale che }-X\sim\EEE(\lambda)\iff\varphi_X(u)=\dfrac{\lambda}{\lambda+iu}
\]
e
\[
\EE[X]\overset{\underset{\dots}{}}{=}-\frac{1}{\lambda} \qquad \EE[X^2]\overset{\underset{\dots}{}}{=}\frac{2}{\lambda^2}\qquad Var(X)\overset{\underset{\dots}{}}{=}\frac{1}{\lambda^2}
...
\begin{gather*}
\begin{aligned}
&f_X(x)=\frac{1}{2}\ \Ind_{[0,2]}(x)\implies X\sim\UUU([0,2])\\
&f_Y(y)=\Ind_{[0,1]}(y)\implies Y\sim\UUU([0,1])
\end{aligned}
\end{gather*}
...
\[
\begin{cases}X_1,\dots,X_n\text{ indipendenti}\\X_k\sim\PPP(\lambda_k),\ \lambda_k>0\ \forall k\end{cases} \implies X_1+\cdots+X_n\sim\PPP(\lambda_1+\cdots+\lambda_n)
\]
...
Quindi
\[
X_1,\dots,X_n\iid\EEE(\lambda),\ n\in\NN,\ \lambda>0\implies X_1+\cdots+X_n\sim\Gamma(n,\lambda)
\]
...
Quindi
\[
Z\sim\NNN(0,1)\implies Z^2\sim\Gamma\left(\frac{1}{2},\frac{1}{2}\right)=\chi^2(1)
\]
\begin{oss}
...
In generale
\[
Z_1,\dots,Z_n\iid\NNN(0,1)\implies Z_1^2+\cdots+Z_n^2\sim\Gamma\left(\frac{n}{2},\frac{1}{2}\right)=\chi^2(n)
\]
\end{enumerate}
