...
Consideriamo infinite prove di Bernoulli indipendenti con probabilità di successo $p\in (0,1)$. Siano quindi $\Omega =\{0,1\}^{\NN}$ e $\Ac =\sigma (E_{k} \mid k=1,2,\dots)$,
\begin{equation*}
