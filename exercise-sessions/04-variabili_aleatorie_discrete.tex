...
VA: Sia $(\Omega ,\mathcal{A} ,\PP)$ uno spazio di probabilità. Una funzione $X:(\Omega ,\mathcal{A})\rightarrow (\RR ,\mathcal{B})$ si dice variabile aleatoria reale se è misurabile, i.e. $\forall B\in \mathcal{B} ,X^{-1}(B) \in \mathcal{A}$.
...
\begin{equation*}
\Ind_{A} :(\Omega ,\mathcal{A})\rightarrow \{0,1\} \subset \RR
\end{equation*}
e
\begin{equation*}
\begin{drcases}
...
\item
\begin{theorem}
Sia $X$ una VA reale definita su $(\Omega ,\mathcal{A} ,\PP)$ e sia $h:\RR\rightarrow \RR$ boreliana. Allora
\begin{equation*}
...
\begin{gather*}
\begin{aligned}
X_{n}(\Omega ,\mathcal{A}) & \rightarrow (\RR ,\mathcal{B})\\
...
\begin{equation*}
(\Omega ,\mathcal{A} ,\PP) =(\RR ,\mathcal{B} ,\PP_{\text{unif.}})
\end{equation*}
...
Infatti:
\begin{equation*}
\EE[X] =\underbrace{\int_{\Omega } X(\omega) d\PP(\omega) =\int_{\RR} xdP^{X}(x)}_{\text{Teorema "astratto-concreto"}}\overset{\text{discreta}}{=}\sum\limits_{x\in S} xp_{X}(x) =\sum\limits_{x\in S} x\PP(X=x)
\end{equation*}
