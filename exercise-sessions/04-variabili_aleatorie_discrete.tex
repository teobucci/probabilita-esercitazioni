...
\item $V\coloneqq \liminf _{n} X_{n}$, $U\coloneqq \limsup _{n} X_{n}$ sono VA perché, rispettivamente, $\liminf _{n}$ e $\limsup _{n}$ di VA. In particolare\begin{align*}
V & =\liminf _{n} X_{n} =\liminf _{n}\Ind_{E_{n}} =\Ind_{\liminf\limits _{n} E_{n}}
\end{align*}

l'ultimo passaggio è giustificato dal fatto che\begin{align*}
...
\end{equation*}Avremo\begin{align*}
\EE[ X] & =\sum\limits _{x\in S} xp_{X}( x) & \\
...
Il passaggio (b1) è giustificato da\begin{align*}
